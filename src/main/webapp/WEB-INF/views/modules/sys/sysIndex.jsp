    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            function getNotifyNum() {
                /*$.get("
                ${ctx}/oa/oaNotify/self/count?updateSession=0&t="+new Date().getTime(),function(data){
            ...
            <ul id="userControl" class="nav pull-right">
                <li>
                    <a href="${pageContext.request.contextPath}${fns:getAdminPath()}"
                       target="_blank" title="刷新网站"><i class="icon-home"></i></a></li>
                ...
                <li>
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#" title="扫描额度">剩余扫描额度： ${fns:getUser().surplusTotal}&nbsp;<span
                            id="notifyNum" class="label label-info hide"></span></a>
                </li>
